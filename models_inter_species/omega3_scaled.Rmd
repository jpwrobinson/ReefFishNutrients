---
title: "Omega-3 model - full dataset, scaled"
...
print('Priors are:')
print(posts %>% filter(nut == 'omega3') %>% select(nut,covariate, post, sd)) %>% mutate(post = round(post,3), sd = round(sd,3))
