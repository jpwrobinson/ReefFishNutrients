...
nt_m<-ulam(
        ...
        data=focal.fit, iter=5000, warmup=1500, chains=3, cores = 6, log_lik=TRUE, control=list(adapt_delta=0.99), messages=FALSE)
...
pred<-expand.grid(species = unique(focal$species),
	...
	meds<-exp(link(nt_m, data = pred, post=post, n=1000))
