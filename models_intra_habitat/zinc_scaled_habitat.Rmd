---
title: "Zinc model - habitat dataset, scaled"
...
## drop microdon - only 1 sample
focal <- focal %>% filter(species  != 'Lethrinus microdon')
...
nt_m<-ulam(
        alist(
          ...
          # fixed priors
          a ~ dnorm(-0.131, 0.172),
          B3 ~ dnorm(-0.208, 0.124),
    		  B4 ~ dnorm(-0.245, 0.126),
    		  B5 ~ dnorm(-0.0441, 0.158),
    		  B6 ~ dnorm(0.121, 0.144),
    		  B7 ~ dnorm(0.0752, 0.119),
    		  B8 ~ dnorm(0, 1),
    		  X1[site] ~ dnorm(0, 1),
    		  X2[family] ~ dnorm(0, 1),
          # vector[2]:sigma_species ~ dexp(1),
          c(sigma_species, sigma_site, sigma_fam) ~ dexp(2),
          scale ~ dexp(2),
    		  Rho ~ lkj_corr(2)
