...
nt_m <- ulam(
    alist(
        ...
        mu <- a + b*PC1 + X1[Location]*sigma_site + X2[Year]*sigma_fam,
		...
		c(sigma, sigma_site, sigma_fam) ~ dcauchy(0, 1)
			), 
...
add_label(0.76, 0.09, 'Calcium', font=2, cex=1.2)
mtext(2, text=expression(paste('mg 100g'^-1)), line=2, cex=0.8)
